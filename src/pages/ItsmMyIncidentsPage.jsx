...
const ItsmMyIncidentsPage = () => {
  usePageTitle('My Incidents');
  return (
    <MasterLayout>
      <Breadcrumb title='ITSM / My Incidents' />
      <div className='card'>
        <div className='card-header border-bottom-0 pb-0'>
          <h6 className='mb-0'>My Incidents</h6>
        </div>
        <div className='card-body p-20 pt-12'>
          <DataTable
            ...
            data={mockIncidents.filter(i => i.assignee === 'you')}
            defaultSortKey='id'
...
export default ItsmMyIncidentsPage;
